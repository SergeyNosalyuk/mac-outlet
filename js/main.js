...
items.map((item) => {
    ...
    const iconLikeBlock = document.createElement('div');
    iconLikeBlock.className = 'icon-like-block'
    cardBody.appendChild(iconLikeBlock)

    const likeIcon = document.createElement('img');
    likeIcon.src = 'img/icons/like_empty.svg';
    iconLikeBlock.appendChild(likeIcon)
      
    const itemImg = document.createElement('img');
    itemImg.className = 'card-image';
    ...
    const leftInStock = document.createElement('span');
    const leftInStockPCS = item.orderInfo.inStock;
    leftInStock.className = 'card-description';
    leftInStock.innerText = `${leftInStockPCS} left in stock`;
    cardBody.appendChild(leftInStock);

    const checkIconBlockSection = document.createElement('div');
    checkIconBlockSection.className = 'check-icon-block-section'
    cardBody.appendChild(checkIconBlockSection)

    const checkIcon = document.createElement('img');
    checkIcon.className = 'icon-check-block';
    if(leftInStockPCS){
        checkIcon.src = 'img/icons/check.svg';
    } else {
        checkIcon.src = 'img/icons/close1.svg';
    }
    checkIconBlockSection.appendChild(checkIcon);

    const price = document.createElement('span');
    price.className = 'card-description';
    ...
    if(leftInStockPCS === 0){
        itemButton.className = 'card-btn-disabled';
    } else {
        itemButton.className = 'bottom-btn-active';
    }      
    ...
    const iconLikedFilledBlock = document.createElement('div');
    iconLikedFilledBlock.className = 'icon-like-filled-block';
    cardFooter.appendChild(iconLikedFilledBlock);

    const likedFilledIcon = document.createElement('img');
    likedFilledIcon.src = 'img/icons/like_filled.svg';
    iconLikedFilledBlock.appendChild(likedFilledIcon);

    const positiveReviews = document.createElement('p');
    positiveReviews.className = 'column-reviews'; 
    positiveReviews.innerText = item.orderInfo.reviews + '%' + ' Positive reviews Above avarage';
    cardFooter.appendChild(positiveReviews);

    const columnOrders = document.createElement('p');
    columnOrders.className = 'column-orders'; 
    columnOrders.innerText = '999 orders';
    cardFooter.appendChild(columnOrders);
    })
};
...
function price(){
    ...
    let arr_price=[]
    let min_value=document.getElementsByClassName("from_top")[0].value
    let max_value=document.getElementsByClassName("to_bottom")[0].value
    ...
    createCard(arr_price)
}

const filterMenuBtn = document.getElementById('search_icon-filter');
const filterMenu = document.getElementById('filter-block-close');

filterMenuBtn.addEventListener('click', function() {
   if(filterMenu.className === 'filter-block') {
      filterMenu.className = 'filter-block-close';
   } else if (filterMenu.className = 'filter-block-close') {
      filterMenu.className = 'filter-block';
   }
})


const dropDownPriceBtn = document.getElementById('price-btn');
const priceContent = document.getElementById('price-content');

dropDownPriceBtn.addEventListener('click', function() {
   if(priceContent.className === 'price-content') {
      priceContent.className = 'price-content-close';
   } else if (priceContent.className = 'price-content-close') {
      priceContent.className = 'price-content';
   }
})
const priceBtn = document.getElementById('price-btn');
dropDownPriceBtn.addEventListener('click', function() {
   if(priceBtn.className === 'price-btn') {
      priceBtn.className = 'price-btn-close' ;
   } else if (osBtn.className = 'price-btn-close') {
      priceBtn.className = 'price-btn';
   }
})


const dropDownColorBtn = document.getElementById('color-btn');
const colorContent = document.getElementById('color-content');

dropDownColorBtn.addEventListener('click', function() {
   if(colorContent.className === 'color-content') {
      colorContent.className = 'color-content-close';
   } else if (colorContent.className = 'color-content-close') {
      colorContent.className = 'color-content';
   }
})
const colorBtn = document.getElementById('color-btn');
dropDownColorBtn.addEventListener('click', function() {
   if(colorBtn.className === 'color-btn') {
      colorBtn.className = 'color-btn-close' ;
   } else if (osBtn.className = 'color-btn-close') {
      colorBtn.className = 'color-btn';
   }
})


const dropDownMemoryBtn = document.getElementById('memory-btn');
const memoryContent = document.getElementById('memory-content');

dropDownMemoryBtn.addEventListener('click', function() {
   if(memoryContent.className === 'memory-content') {
      memoryContent.className = 'memory-content-close';
   } else if (memoryContent.className = 'memory-content-close') {
      memoryContent.className = 'memory-content';
   }
})
const memoryBtn = document.getElementById('memory-btn');
dropDownMemoryBtn.addEventListener('click', function() {
   if(memoryBtn.className === 'memory-btn') {
      memoryBtn.className = 'memory-btn-close' ;
   } else if (osBtn.className = 'memory-btn-close') {
      memoryBtn.className = 'memory-btn';
   }
})


const dropDownOsBtn = document.getElementById('os-btn');
const osContent = document.getElementById('os-content');

dropDownOsBtn.addEventListener('click', function() {
   if(osContent.className === 'os-content') {
      osContent.className = 'os-content-close';
   } else if (osContent.className = 'os-content-close') {
      osContent.className = 'os-content';
   }
})
const osBtn = document.getElementById('os-btn');
dropDownOsBtn.addEventListener('click', function() {
   if(osBtn.className === 'os-btn') {
      osBtn.className = 'os-btn-close' ;
   } else if (osBtn.className = 'os-btn-close') {
      osBtn.className = 'os-btn';
   }
})


const dropDownDisplayBtn = document.getElementById('display-btn');
const displayContent = document.getElementById('display-content');

dropDownDisplayBtn.addEventListener('click', function() {
   if(displayContent.className === 'display-content') {
      displayContent.className = 'display-content-close' ;
   } else if (displayContent.className = 'display-content-close') {
      displayContent.className = 'display-content';
   }
})
const displayBtn = document.getElementById('display-btn');
dropDownDisplayBtn.addEventListener('click', function() {
   if(displayBtn.className === 'display-btn') {
      displayBtn.className = 'display-btn-close' ;
   } else if (displayBtn.className = 'display-btn-close') {
